...
class Endpoint(Base):
	...
	kind = Column(Enum(EndpointKind, values_callable=lambda obj: [e.value for e in obj]), nullable=False)
	method = Column(String(10), nullable=True)
	url_path = Column(String(512), nullable=True)
	topic = Column(String(255), nullable=True)
	direction = Column(Enum(Direction, values_callable=lambda obj: [e.value for e in obj]), nullable=True)
...
class Interaction(Base):
	...
	edge_type = Column(Enum(EdgeType, values_callable=lambda obj: [e.value for e in obj]), nullable=False)
...
class Scan(Base):
	...
	status = Column(Enum(ScanStatus, values_callable=lambda obj: [e.value for e in obj]), default=ScanStatus.QUEUED)
